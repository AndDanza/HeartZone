...
/**
 * The type Medications tile representation.
 */
public class MedicationsTileRepresentation implements ModularRepresentation {
    ...
    /**
     * Instantiates a new Medications tile representation.
     *
    ...
    public void SetAdapter() {
        adapter = new MedicationsRecyclerAdapter(R.layout.medication_tile_item, medications, companies);
